...
void ShowCode(HTNode treeNodes[], int treeNodeCount, char text) {
    for (int i = 0; i < treeNodeCount; i++) {
...
void ShowCodeTable(HTNode treeNodes[], int treeNodeCount, int leafNodeCount) {
    ...
    for (int i = 0; i < leafNodeCount; i++) {
        ...
        ShowCode(treeNodes, treeNodeCount, treeNodes[i].text);
        printf("\n");
    }
}
...
void EncodeText(HTNode treeNodes[], int treeNodeCount, int leafNodeCount) {
    ...
    for (int i = 0; i < strlen(text); i++) {
        ShowCode(treeNodes, treeNodeCount, text[i]);
    }
}

void DecodeText(HTNode treeNodes[], int treeNodeCount, int leafNodeCount) {
    char code[50];
    scanf("%s", code);

    for (int i = 0; i < strlen(code); i++) {
        ShowCode(treeNodes, treeNodeCount, code[i]);
    }
}
