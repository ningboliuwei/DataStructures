...
PolyLinkNode *AddPoly(PolyLinkNode *poly1, PolyLinkNode *poly2) {
    PolyLinkNode *p1 = new PolyLinkNode;
    p1->next = NULL;
    PolyLinkNode *p2 = new PolyLinkNode;
    poly2->next = NULL;
    PolyLinkNode *poly = (PolyLinkNode *)malloc(sizeof(PolyLinkNode));
    PolyLinkNode *p = (PolyLinkNode *)malloc(sizeof(PolyLinkNode));
    p = poly;
    while (p1 && p2) {
...
int main() {
    ...
    PolyLinkNode *poly = new PolyLinkNode;
    AddPoly(poly1, poly2);
    PolyLinkNode *p = new PolyLinkNode;
    p = poly->next;
    while (p) {
        printf("%fx^%f ", p->data.coef, p->data.exp);
        p = p->next;
    }
    printf("\n");
    return 0;
