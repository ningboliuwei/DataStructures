    ...
    while (scanf("%c", &currentChar) && currentChar != '#') {
        ...
        if (currentChar == '0' || currentChar == '1' || currentChar == '2' || currentChar == '3' || currentChar == '4'
            ...
            if (IsEmptyStack(expressionStack)) {
                ...
                // 当前输入的运算符优先级为止
                while (stackTopOperatorLevel < currentOperatorLevel && !IsEmptyStack(expressionStack)) {
                ...
                if (currentOperatorLevel > stackTopOperator) { Push(expressionStack, currentChar); }
            }
        }
    }
